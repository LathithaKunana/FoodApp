...
import {  HeartIcon, Square3Stack3DIcon, UserIcon, UsersIcon } from 'react-native-heroicons/solid';
    ...
    >
        ...
        <View className=" flex-row justify-center">
            <CachedImage 
                ...
                style = {{width: wp(97), height: hp(50), borderRadius:33, borderBottomLeftRadius: 40, borderBottomRightRadius: 40, marginTop: 6}}
            />
        </View>
        {/* back button */}
        ...
        {/* meal description */}
         {
            loading? (
                ...
                <View className="px-4 flex justify-between space-y-4 pt-8">
                    {/* name of meal and area it is from */}
                    ...
                    <Animated.View entering={FadeInDown.delay(100).duration(700).springify().damping(12)} className=" flex-row justify-around">
                        <View className="flex rounded-full bg-amber-400 justify-center p-2">
                            <View
                    ...
                    {/* ingredience */}
                    <Animated.View entering={FadeInDown.delay(200).duration(700).springify().damping(12)}iew className="space-y-4">
                        <Text style={{fontSize: hp(2.5)}} className="font-bold flex-1 text-neutral-700">
                            Ingredents
                        </Text>
                        <View className="space-y-2 ml-3">
                            {
                                IngredentsIndexes(meal).map( i => {
                                    return(
